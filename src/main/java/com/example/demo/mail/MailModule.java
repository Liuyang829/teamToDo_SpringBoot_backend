...
public class MailModule {
    // 发送邮件的账号
    public static String ownEmailAccount = "zyh_shdx@163.com";
    // 发送邮件的密码------》授权码
    public static String ownEmailPassword = "zyh19980310";
    // 发送邮件的smtp 服务器 地址
    public static String myEmailSMTPHost = "smtp.163.com";
    // 发送邮件对方的邮箱
    public static String receiveMailAccount = "1372241206@qq.com";
...
//         创建邮件对象
    ...
    public static Message createSimpleMail(Session session,String email,String code) throws Exception {
        MimeMessage message = new MimeMessage(session);
        // 设置发送邮件地址,param1 代表发送地址 param2 代表发送的名称(任意的) param3 代表名称编码方式
        message.setFrom(new InternetAddress(ownEmailAccount, "teamToDo", "utf-8"));
        // 代表收件人
        ...
        String content="<h2>您的验证码是:"+code+"</h2>";
        message.setSubject("teamToDo注册");
        // 设置邮件内容
